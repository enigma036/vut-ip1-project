...
Project developed for VUT FIT Individual Project (IP1) course.

## Acknowledgments

- Oasis Protocol for Sapphire blockchain
- iden3 for Circom and SnarkJS libraries
- Hermez Network for Powers of Tau ceremony
